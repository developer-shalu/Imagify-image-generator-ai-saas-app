...
function Description() {
  return ( 
    ...
    <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        <img src={assets.sample_img_1} alt="" srcSet="" className='w-80 xl:w-96 rounded-lg'/>
        <div>
