   ...
   animate={{opacity:1, y: 0}}
    transition={{delay:0.2, duration: 0.8}}>
      ...
      transition={{default: {duration:0.3}, opacity: {delay:0.8, duration: 1}}}>
        Generate Images<img className='h-6' src={assets.star_group} alt="" srcSet="" />
      </motion.button>
      <motion.div 
      initial={{ opacity: 0}}
      animate={{opacity:1}}
      ...
      className='mt-2 text-neutral-600'>Generated images frm imagigy</motion.p>
    </motion.div>
  )
}
